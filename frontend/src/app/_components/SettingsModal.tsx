        ...
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8">
            ...
            <div className="border-t pt-8">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">{t('settingsModal.aiModelConfig')}</h4>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    {t('modelSettings.summarizationModel')}
                  </label>
                    ...
                    <div className="grid gap-4 max-h-[400px] overflow-y-auto pr-2">
                      {models.map((model) => (
                        ...
                        >
                          ...
                          <p className="text-gray-600">{t('settingsModal.size', { size: model.size })}</p>
                          <p className="text-gray-600">{t('settingsModal.modified', { modified: model.modified })}</p>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          <div className="mt-6 flex justify-end">
            <button
              onClick={() => {
                ...
                toast.success(t('settingsModal.devicesSelected'), {
        ...
        <div className="bg-white rounded-lg max-w-4xl w-full mx-4 shadow-xl max-h-[90vh] flex flex-col">
          ...
          <div className="flex justify-between items-center p-6 pb-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">
              {messages.modelSelector ? t('settingsModal.speechRecognitionSetup') : t('settingsModal.transcriptionModelSettings')}
            </h3>
            <button
          ...
          <div className="p-6 pt-4 border-t border-gray-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-700">{t('settingsModal.showConfidence')}</p>
                <p className="text-xs text-gray-500">{t('settingsModal.showConfidenceDesc')}</p>
              </div>
            </div>
    ...
    {modals.chunkDropWarning && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <Alert className="max-w-lg mx-4 border-yellow-200 bg-white shadow-xl">
          <AlertTitle className="text-yellow-800">{t('settingsModal.performanceWarning')}</AlertTitle>
