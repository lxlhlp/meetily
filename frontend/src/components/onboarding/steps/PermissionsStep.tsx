...
export function PermissionsStep() {
  ...
  const handleMicrophoneAction = async () => {
    if (permissions.microphone === 'denied') {
      ...
      try {
        ...
        alert(t('onboarding.enableMicInSystemSettings'));
      }
      return;
    }
  ...
  const handleSystemAudioAction = async () => {
    if (permissions.systemAudio === 'denied') {
      ...
      try {
        ...
        alert(t('onboarding.enableSystemAudioInSettings'));
      }
      return;
    }
  ...
  return (
    <OnboardingContainer
      title={t('onboarding.permissionTitle')}
      description={t('onboarding.permissionDesc')}
      step={4}
      hideProgress={true}
      ...
      <div className="max-w-lg mx-auto space-y-6">
        ...
        <div className="space-y-4">
          ...
          <PermissionRow
            ...
            description={t('onboarding.permissionMicDesc')}
          ...
          <PermissionRow
            ...
            title={t('device.systemAudio')}
            description={t('onboarding.permissionSystemDesc')}
        ...
        <div className="flex flex-col gap-3 pt-4">
          ...
          {!allPermissionsGranted && (
            <p className="text-xs text-center text-muted-foreground">
              {t('onboarding.permissionWarning')}
            </p>
          )}
        </div>
      </div>
