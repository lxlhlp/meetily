...
// i18n key mapping for beta feature names & descriptions
const BETA_FEATURE_NAME_KEYS: Record<BetaFeatureKey, string> = {
  importAndRetranscribe: 'settings.betaFeatureImport',
};
const BETA_FEATURE_DESC_KEYS: Record<BetaFeatureKey, string> = {
  importAndRetranscribe: 'settings.betaFeatureImportDesc',
};
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900">
                  {t(BETA_FEATURE_NAME_KEYS[featureKey])}
                </h3>
              ...
              <p className="text-sm text-gray-600">
                {t(BETA_FEATURE_DESC_KEYS[featureKey])}
              </p>
            </div>
